...
public class Renderer implements GLEventListener {
    ...
    private int size = (int) Math.pow(groupSize, 7);
    ...
    private int offset = 4, compute = 0;
    private int locSize;
    ...
    public void init(GLAutoDrawable glDrawable) {
        ...
        computeShaderProgram = ShaderUtils.loadProgram(gl, "/computeTest");

        locOffset = gl.glGetUniformLocation(computeShaderProgram, "offset");
        locSize = gl.glGetUniformLocation(computeShaderProgram, "size");
    ...
    public void display(GLAutoDrawable glDrawable) {
        ...
        if (offset > 0) {
            ...
            System.out.println(String.format("Time spent on the GPU 2-1 (bind): %f ms\n", (time2.get(0) - time1.get(0)) / 1000000.0));
            System.out.println(String.format("Time spent on the GPU 3-2 (dispatch): %f ms\n", (time3.get(0) - time2.get(0)) / 1000000.0));
            System.out.println(String.format("Time spent on the GPU 3-1 (all): %f ms\n", (time3.get(0) - time1.get(0)) / 1000000.0));
